        ...
        <>
          <div className="skill-graph-header pb-3">
            <div className="flex flex-wrap items-start gap-x-8 gap-y-4">
              ...
              <StatFigure label="Chains" value={stats.clusters} hint="Groups that reference each other" />
              <StatFigure label="Standalone" value={stats.isolated} hint="Hidden from the map" />
            </div>
          </div>
          ...
          <div className="notis-app-split h-auto lg:h-[clamp(480px,calc(100vh-190px),900px)]">
            <div
              ...
              style={{
                ...
                // notis-app-pane-detail applies flex: 1 1 0% at every size so
                // the pane fills the row on desktop; overriding the basis
                // back to auto keeps the explicit mobile height (below) in
                // control instead of the 0% flex-basis collapsing it.
                flexBasis: 'auto',
              }}
              role="application"
              aria-label="Skill graph"
              className="notis-app-pane-detail relative h-[clamp(360px,60vh,620px)] lg:h-auto"
            >
