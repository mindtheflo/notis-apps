...
export default defineNotisApp({
  ...
  skills: [
    { key: 'demo-plan', path: './skills/demo-plan/', name: 'demo-plan', description: 'Inert fictional planning skill' },
    { key: 'demo-check', path: './skills/demo-check/', name: 'demo-check', description: 'Inert fictional review skill' },
